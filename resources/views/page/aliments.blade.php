...
<section class="pt-3" style="background: #fff">
    <div class="d-sm-flex align-items-center justify-content-between">
        <h4 class="h4 text-primary mb-3" style="font-family: 'Trebuchet MS'"><b>Gestion des Aliments</b></h4>
    </div>
            ...
            <div class="col-sm-5 mb-3">
                <div class="card h-100 shadow mb-4" style="font-family: 'Trebuchet MS';color:black;">
                    <div class="card-header py-3 text-center">
                        <h6 class="m-0 font-weight-bold text-primary">Enregistrement des Aliments</h6>
                    </div>
                    <div class="card-body">
                        <div class="pt-4">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-5 mb-3 mb-sm-0">
                                        <label for="libelle" style="color:black;" class="form-control bg-light  text-center">L'Aliment:</label>
                                    </div>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-5 mb-3 mb-sm-0">
                                        <label for="libelle" style="color:black;" class="form-control bg-light text-center">Catégorie:</label>
                                    </div>
                                    <div class="col-sm-7">
