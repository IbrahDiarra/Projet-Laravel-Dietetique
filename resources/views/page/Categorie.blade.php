...
<section class="pt-3" style="background: #fff">
    <div class="d-sm-flex align-items-center justify-content-between">
        <h4 class="h4 text-primary mb-3" style="font-family: 'Trebuchet MS'"><b>Gestion des Catégories</b></h4>
    </div>
            ...
            <div class="col-sm-5 mb-3">
                <div class="card h-100 shadow mb-4" style="font-family: 'Trebuchet MS';color:black;">
                    <div class="card-header py-3 text-center">
                        <h6 class="m-0 font-weight-bold text-primary">Enregistrement des Catégories</h6>
                    </div>
                    <div class="card-body">
                        <div class="pt-4">
