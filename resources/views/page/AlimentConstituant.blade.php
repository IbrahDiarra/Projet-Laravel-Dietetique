...
<section class="pt-3" style="background: #fff">
    <div class="">
        <h4 class="h4 mb-0 text-primary mb-3" style="font-family: 'Trebuchet MS'"><b>Gestions des Aliments Composants</b></h4>
        <p style="font-family:'Trebuchet MS'; color:black;">
            Cette page établit la relation entre les aliments et leurs composants,
            ainsi que la quantité de chaque composant dans un aliment donné.
        </p>
    </div>
                ...
                <div class="col-sm mb-3">
                    <div class="card h-100 shadow mb-4" style="font-family: 'Trebuchet MS';color:black;">
                        <div class="card-header py-3 text-center">
                            <h6 class="m-0 font-weight-bold">Enregistrement des Aliments Composants</h6>
                        </div>
                        <div class="card-body">
                            <div class="pt-4">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <label for="libelle" class="bg-light form-control text-center" style="color:black;">Libellé de l'Aliment:</label>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <button type="button" class="btn btn-secondary btn-user btn-block" onclick="addComposantEntry()">Ajouter un Composant</button>
                                        </div>
                                        <div class="col-sm-6">
